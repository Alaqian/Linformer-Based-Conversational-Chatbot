...
def main():
	...
	parser.add_argument('--weight', default="weight", type=str, help='Name to save weights at /saved/weights/<name>')
	parser.add_argument('--train', default="data2_train_9010", type=str, help='Name to train file at /saved/data/<name>')
	parser.add_argument('--test', default="data2_test_9010", type=str, help='Name to test file at /saved/data/<name>')
	...
	parser.add_argument('--modeler', default="linformer", type=str, help='Modler: transformer or linformer')
	parser.add_argument('--linear_dimension', default=256, type=int, help='Linear Dimension of Attention Layers')
	parser.add_argument('--scheduler', default="plateau", type=str, help='Scheduler: plateau, cosine or warmup')
