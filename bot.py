...
# 	print(device)
	...
	if(args.model.lower() == "transformer"):
		...
		max_len = args.linear_dimension
	else:
		print("Please choose a model between \"Transformer\" and \"Linformer\"")
		quit()
	opt = Options(batchsize=32, device=torch.device("cpu"), epochs=200, lr=0.01, max_len = max_len, save_path = f'saved/weights/{args.weight}')
